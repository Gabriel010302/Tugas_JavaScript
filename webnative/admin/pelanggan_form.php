...
<form action="pelanggan_controller.php" method="POST">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="nama_pelanggan" name="nama_pelanggan" type="text" class="form-control" value="<?= $pel['nama_pelanggan']?>">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        <label for="text6" class="col-4 col-form-label">ID Kartu</label> 
        <div class="col-8">
